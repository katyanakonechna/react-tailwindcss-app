...
const Dashboard = () => {
    ...
    return <div className="flex flex-col bg-chocolate-300 bg-opacity-80 min-h-screen">
        ...
        <div className="bg-chocolate-300 bg-opacity-90 rounded-t-2xl flex-1 overflow-hidden relative flex-col flex h-full">
            <h3 className="font-bold text-chocolate-50 px-4 lg:px-8 py-2">News:</h3>
            <div id="news" className="font-bold text-chocolate-50 px-4 lg:px-8 py-2 h-full min-h-0 overflow-auto min-h-0" >
